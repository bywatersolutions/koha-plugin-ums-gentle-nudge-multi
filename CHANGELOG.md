...
### Fixed
- Fixed incorrectly formatted headers in csv for sync
...
### Fixed
- Sync/Update subroutine not creating CSV

## [0.9.15] - 2026-08-24

### Fixed
- Change structure of sync subroutine
...
## Added
- Make uninstall drop the tables

## [0.9.6] - 2026-08-11

### Fixed
- Additional mismatch with sftp and sftp_server fixes
...
### Fixed
- Column name mismatch between table and API
